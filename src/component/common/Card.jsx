...
const Card = ({ title, description }) => {
	return (
		<div>
			<div className="flex gap-20 left-5 top-4.25 w-83.5 h-101 flex-col justify-items-center rounded-[25px]  bg-[linear-gradient(101deg,rgba(13,77,56,0.2)_18.53%,rgba(8,136,88,0.2)_81.47%)]  backdrop-blur-[5px]  shadow-[0_10px_30px_-12px_rgba(7,117,80,0.35)] hover:-translate-y-1 hover:shadow-[0_18px_40px_-10px_rgba(7,117,80,0.45)] transition-all duration-300 ">
